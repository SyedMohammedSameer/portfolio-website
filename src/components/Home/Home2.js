        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              Whenever possible, I also apply my passion for AI
              with <b className="purple">Automation tools</b> and
              <i>
                <b className="purple">
                  {" "}
                  Agentic frameworks
              ...
              &nbsp; like
              <i>
                <b className="purple"> OpenAI, AutoGPT</b>
              </i>
            </p>
          </Col>
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://x.com/Smd_Sameer_10"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
